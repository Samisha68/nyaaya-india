...
export default function Sources() {
  return <main>
    <nav className="nav"><a className="brand" href="/"><span>N</span>Nyaaya</a><div className="navlinks"><a href="/sources">Sources</a><a href="/#about">About</a></div></nav>
    ...
    <footer><div className="brand"><span>N</span>Nyaaya</div><p>Legal information for everyone in India.</p><small>This platform provides legal information and guidance, not legal advice. Laws and procedures may depend on your specific circumstances and jurisdiction.</small></footer>
  </main>;
}
